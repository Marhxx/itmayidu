...
public class TbWords implements java.io.Serializable {
	...
	public TbWords(String twCode, String twName, Integer twStatus, String twMemo) {
		super();
		this.twCode = twCode;
		this.twName = twName;
		this.twStatus = twStatus;
		this.setTwMemo(twMemo);
	}

	/** full constructor */
	public TbWords(String twCode, String twName, Timestamp twAddDate,
			Long twAddPerson, Integer twStatus, String twValue,String twMemo) {
		this.twCode = twCode;
		this.twName = twName;
