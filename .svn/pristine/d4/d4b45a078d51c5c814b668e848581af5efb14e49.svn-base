...
public class TbInformationCataServiceImpl extends
	...
	@Override
	public List<Map<String, Object>> findList(String ticId) {
		String sql = "select * From tb_information_cata where tic_parent_id = "+ticId+" and tic_status <> 0 ";
		return tbInformationCataDao.searchForMap(sql, null);
	}
}
